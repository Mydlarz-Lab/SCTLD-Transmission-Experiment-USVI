...
# Add three columns in excel:
  # 1: "type" column after "pval" with formula:
    # =IF(G2<0.3375006,"Lineage Specific","Highly Variable")    # G2 = "beta" column
...
mcav_annot <- read.csv("~/OneDrive - University of Texas at Arlington/Dissertation/SCTLD/Files_for_R/January_2022/SCTLD/host/all/Orthofinder_cdhit/Annotation/mcav_sc_orthologs_annotated.csv")
mcav_contig <- read.csv("~/OneDrive - University of Texas at Arlington/Dissertation/SCTLD/Files_for_R/January_2022/SCTLD/host/all/Orthofinder_cdhit/Orthogroups/mcav_contig_to_orthogroup.csv")
...
# [1] 78 57
names(results)
results <- results %>% relocate(mcav_contig, .after = Orthogroup)
results <- results %>% relocate(Entry, .after = mcav_contig)
...
names(results)
results <- results[,-c(1)]
dim(results)    # 53 significant Highly Variable EVE genes with good evalue
names(results)

resorderd <-results[order(results$CvI),] 
resorderd <- resorderd %>% filter(CvI < (0.05)) 
dim(resorderd)  #44 significantly different between control and infected
...
[1] "Q96LD1  corr: 0.884915512995971  p-value: 0.0460485845095573"
[1] "Q4R5P6  corr: 0.911168059252092  p-value: 0.0313555524128266"
...
```
[1] "Q9D428  corr: -0.895959996179715  p-value: 0.0396495317574438"
[1] "Q8VEE0  corr: -0.890625079348999  p-value: 0.0427025641300313"
[1] "Q8TBH0  corr: 0.990478243420906  p-value: 0.00111375126418337"
[1] "Q63ZP1  corr: -0.889928346436799  p-value: 0.043106570616167"
[1] "Q8VBV7  corr: -0.910697691281558  p-value: 0.0316026276117893"
