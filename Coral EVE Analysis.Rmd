...
OG0010466_species_stats <- ggplot_build(OG0010466_species)
OG0010466_species_stats$data

OG0010466_status_stats <- ggplot_build(OG0010466_status)
OG0010466_status_stats$data
```
...
OG0011934_species_stats <- ggplot_build(OG0011934_species)
OG0011934_species_stats$data

OG0011934_status_stats <- ggplot_build(OG0010466_status)
OG0011934_status_stats$data
```
...
OG0011066_species_stats <- ggplot_build(OG0011066_species)
OG0011066_species_stats$data

OG0011066_status_stats <- ggplot_build(OG0011066_status)
OG0011066_status_stats$data
```
...
OG0010904_species_stats <- ggplot_build(OG0010904_species)
OG0010904_species_stats$data

OG0010904_status_stats <- ggplot_build(OG0010904_status)
OG0010904_status_stats$data
```
...
OG0010176_species_stats <- ggplot_build(OG0010176_species)
OG0010176_species_stats$data

OG0010176_status_stats <- ggplot_build(OG0010176_status)
OG0010176_status_stats$data
```
...
```{r}
# Create dataframe for Source Data file
## Q6NWF4 - Vacuolar protein-sorting-associated protein 25
## Q96LD1 - Zeta-sarcoglycan
## Q4R5P6 - Cytoplasmic dynein 1 light intermediate chain 2

colnames(LS_rlogs)
source_data <- LS_rlogs[,c("Species","RelativeRisk","Q6NWF4","Q4R5P6","Q96LD1")]
```
...
Q96LD1_stats <- ggplot_build(Q96LD1)
Q96LD1_stats$data
...
Q4R5P6_stats <- ggplot_build(Q4R5P6)
Q4R5P6_stats$data
...
Q6NWF4_stats <- ggplot_build(Q6NWF4)
Q6NWF4_stats$data
```
...
```{r}
# Create dataframe for Source Data file
## Q9D428 - Golgin subfamily A member 7B
## Q8VEE0 - Ribulose-phosphate 3-epimerase
## Q8TBH0 - Arrestin domain-containing protein 2
## Q63ZP1 - PHD finger protein 10
## Q8VBV7 - COP9 signalosome complex subunit 8

colnames(LS_rlogs)
source_data$LGR <- LS_rlogs$LGR
source_data$Q8TBH0 <- LS_rlogs$Q8TBH0
source_data$Q8VBV7 <- LS_rlogs$Q8VBV7
source_data$Q9D428 <- LS_rlogs$Q9D428
source_data$Q8VEE0 <- LS_rlogs$Q8VEE0
source_data$Q63ZP1 <- LS_rlogs$Q63ZP1
source_data

write.csv(source_data,file="~/OneDrive - University of Texas at Arlington/Dissertation/SCTLD/Files_for_R/January_2022/REVISIONS/Final Revision/fig3b_sourceData.csv")
```
...
Q63ZP1_stats <- ggplot_build(Q63ZP1)
Q63ZP1_stats$data
...
Q8VEE0_stats <- ggplot_build(Q8VEE0)
Q8VEE0_stats$data
...
Q8VBV7_stats <- ggplot_build(Q8VBV7)
Q8VBV7_stats$data
...
Q9D428_stats <- ggplot_build(Q9D428)
Q9D428_stats$data
...
Q8TBH0_stats <- ggplot_build(Q8TBH0)
Q8TBH0_stats$data

```

```{r LGR,fig.height=8,fig.width=8,dpi=300}  
